...
const Ansys = () => {
	...
	const getCategory = async () => {
		const res = await axios.get(`/api/ansys/categories`);
	...
	const submitNewHandler = async (e) => {
		...
		await axios.post(`/api/ansys/categories`, data);
		getCategory();
		setIsLoading(false);
		setOpened(false);
		setAddvalue("");
	...
	const submitHandler = async (e) => {
		...
		await axios.put(`/api/ansys/categories/${id}`, data);
		getCategory();
		setIsLoading(false);
		setOpenedEdit(false);
	};
	...
	const deleteHandler = async (e) => {
		setIsLoading(true);
		await axios.delete(`/api/ansys/categories/${id}`);
		getCategory();
		setIsLoading(false);

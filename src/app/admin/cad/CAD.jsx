...
const CAD = () => {
	...
	const getCategory = async () => {
		const res = await axios.get(`/api/cad/categories/`);
	...
	const submitNewHandler = async (e) => {
		...
		await axios.post(`/api/cad/categories/`, data);
		getCategory();
		setIsLoading(false);
		setOpened(false);
		setAddvalue("");
	...
	const submitHandler = async (e) => {
		...
		await axios.put(`/api/cad/categories/${id}`, data);
		getCategory();
		setIsLoading(false);
		setOpenedEdit(false);
	};
	...
	const deleteHandler = async (e) => {
		...
		await axios.delete(`/api/cad/categories/${id}`);
		getCategory();
		setIsLoading(false);
	...
	return (
		<div className="cad categorygrid">
			<Modal
				overlayColor={
